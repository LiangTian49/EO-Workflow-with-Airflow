...
if __name__ == "__main__":
    ...
    output_path = "/p/project/joaiml/liang1/data/output"
    ...
    application_context.input_parameters.s2_data_path = "/p/project/joaiml/liang1/data/input/2018_T32TPS/s2_images"
    ...
    seom_classes_to_load = range(1, 17)
    for seom_class in configuration.seomClcLegend.seom_classes:
