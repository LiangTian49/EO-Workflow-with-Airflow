...
#SBATCH --output=s4_paral-%A_%a.out 
#SBATCH --error=s4_paral-%A_%a.err
#SBATCH --time=2:00:00
#SBATCH --job-name=s4_paral
#SBATCH --array=0-1
...
echo "Run started at:- "
date
srun -N 1 --ntasks-per-node=1 python -u s4_paral.py --id_acquisition ${SLURM_ARRAY_TASK_ID}
